...
proposition (in the sense of conceptually prior to). Then the meaning of
quantification is determined via the range of /valid/ values of a function. But
what determines the /validity/ of this range? He names it "logical homogeneity".
...
How is the homogeneity of such collections enforced?

*** Types as marks of belonging-together
...
*** TODO The question of justification

What justifies such enforcement?

* TODO Types as Theories
